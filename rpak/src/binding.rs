...
extern "C" {
    #[link_name = "\u{1}?decompress_rpak@@YADPEA_J_K1@Z"]
...
extern "C" {
    #[link_name = "\u{1}?get_decompressed_size@@YA_J_JPEAE0000@Z"]
    pub fn get_decompressed_size(
        params: *mut ::std::os::raw::c_longlong, // fix?
        file_buf: *mut u8,
...
extern "C" {
    #[link_name = "\u{1}?hash_string@@YA_KPEAI@Z"]
